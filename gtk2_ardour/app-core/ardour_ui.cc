...
#include "app-core/about.h"
#include "app-core/actions.h"
#include "session-config-dialogs/add_route_dialog.h"
#include "app-core/ardour_message.h"
#include "app-core/ardour_ui.h"
#include "transport-clocks/audio_clock.h"
#include "editor-view/audio_region_view.h"
#include "transport-clocks/big_clock_window.h"
#include "transport-clocks/big_transport_window.h"
#include "app-core/bundle_manager.h"
#include "mixer/meters-monitoring/dsp_stats_window.h"
#include "session-config-dialogs/duplicate_routes_dialog.h"
#include "platform-support/debug.h"
#include "session-config-dialogs/engine_dialog.h"
#include "import-export-video/export_video_dialog.h"
#include "mixer/routing/global_port_matrix.h"
#include "app-core/gui_object.h"
#include "app-core/gui_thread.h"
#include "platform-support/idleometer.h"
#include "midi-pianoroll/instrument_selector.h"
#include "mixer/routing/io_plugin_window.h"
#include "app-core/keyboard.h"
#include "app-core/keyeditor.h"
#include "session-config-dialogs/library_download_dialog.h"
#include "shared-ui/location_ui.h"
#include "lua-scripting/lua_script_manager.h"
#include "lua-scripting/luawindow.h"
#include "transport-clocks/main_clock.h"
#include "plugins/missing_plugin_dialog.h"
#include "mixer/mixer_ui.h"
#include "mixer/meters-monitoring/meterbridge.h"
#include "app-core/mouse_cursors.h"
#include "session-config-dialogs/nsm.h"
#include "session-config-dialogs/opts.h"
#include "plugins/plugin_dspload_window.h"
#include "plugins/plugin_manager_ui.h"
#include "plugins/processor_box.h"
#include "editor-view/public_editor.h"
#include "session-config-dialogs/rc_option_editor.h"
#include "session-config-dialogs/recorder_ui.h"
#include "editor-view/route_time_axis.h"
#include "mixer/routing/route_params_ui.h"
#include "session-config-dialogs/rta_window.h"
#include "session-config-dialogs/save_as_dialog.h"
#include "session-config-dialogs/save_template_dialog.h"
#include "session-config-dialogs/script_selector.h"
#include "session-config-dialogs/session_archive_dialog.h"
#include "session-config-dialogs/session_dialog.h"
#include "session-config-dialogs/session_metadata_dialog.h"
#include "session-config-dialogs/session_option_editor.h"
#include "mixer/routing/speaker_dialog.h"
#include "app-core/splash.h"
#include "session-config-dialogs/template_dialog.h"
#include "editor-view/time_axis_view_item.h"
#include "app-core/timers.h"
#include "transport-clocks/transport_masters_dialog.h"
#include "clips-cues-trigger/trigger_page.h"
#include "clips-cues-trigger/triggerbox_ui.h"
#include "app-core/utils.h"
#include "midi-pianoroll/virtual_keyboard_window.h"
#include "import-export-video/add_video_dialog.h"
#include "plugins/plugin_selector.h"
