...
#include "platform-support/ardour_http.h"
...
#include "lua-scripting/luadialog.h"
#include "lua-scripting/luainstance.h"
#include "lua-scripting/luasignal.h"
...
#include "import-export-video/utils_videotl.h"
...
str2luasignal (const std::string &str) {
	...
	if (0) { }
#	include "lua-scripting/luasignal_syms.inc.h"
	else {
...
#include "session-config-dialogs/ui_config_vars.inc.h"
...
#		include "editor-view/editing_syms.inc.h"
		.endNamespace ();
