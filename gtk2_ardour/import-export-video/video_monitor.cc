...
#include "import-export-video/video_monitor.h"
	...
	: editor (ed)
{
	...
	process->ReadStdout.connect_same_thread (*this, std::bind (&VideoMonitor::parse_output, this, _1 ,_2));
	process->Terminated.connect (*this, invalidator (*this), std::bind (&VideoMonitor::terminated, this), gui_context());
	XJKeyEvent.connect (*this, invalidator (*this), std::bind (&VideoMonitor::forward_keyevent, this, _1), gui_context());
}
