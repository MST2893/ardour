...
{
  return Glib::RefPtr<Gio::DBus::ObjectManagerServer>( dynamic_cast<Gio::DBus::ObjectManagerServer*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
{
  return Glib::RefPtr<ObjectManagerServer>( new ObjectManagerServer(object_path) );
}
