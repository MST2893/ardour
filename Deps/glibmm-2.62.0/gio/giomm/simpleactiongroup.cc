...
{
  Glib::RefPtr<Action> retvalue = Glib::wrap(g_simple_action_group_lookup(gobj(), action_name.c_str()));
  if(retvalue)
...
#ifndef GIOMM_DISABLE_DEPRECATED
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
Glib::RefPtr<const Action> SimpleActionGroup::lookup(const Glib::ustring& action_name) const
{
  return const_cast<SimpleActionGroup*>(this)->lookup(action_name);
}
G_GNUC_END_IGNORE_DEPRECATIONS
#endif // GIOMM_DISABLE_DEPRECATED
