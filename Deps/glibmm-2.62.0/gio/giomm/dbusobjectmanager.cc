...
#include <giomm/private/dbusobjectmanager_p.h>
...
{
  return Glib::RefPtr<Gio::DBus::ObjectManager>( dynamic_cast<Gio::DBus::ObjectManager*> (Glib::wrap_auto_interface<Gio::DBus::ObjectManager> ((GObject*)(object), take_copy)) );
