...
{
  GError* gerror = nullptr;
  TlsInteractionResult retvalue = ((TlsInteractionResult)(g_tls_interaction_ask_password(gobj(), Glib::unwrap(password), nullptr, &(gerror))));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = nullptr;
  TlsInteractionResult retvalue = ((TlsInteractionResult)(g_tls_interaction_invoke_ask_password(gobj(), Glib::unwrap(password), nullptr, &(gerror))));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = nullptr;
  TlsInteractionResult retvalue = ((TlsInteractionResult)(g_tls_interaction_invoke_request_certificate(gobj(), Glib::unwrap(connection), ((GTlsCertificateRequestFlags)(flags)), nullptr, &(gerror))));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
{
  GError* gerror = nullptr;
  TlsInteractionResult retvalue = ((TlsInteractionResult)(g_tls_interaction_request_certificate(gobj(), Glib::unwrap(connection), ((GTlsCertificateRequestFlags)(flags)), nullptr, &(gerror))));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
void TlsInteraction::request_certificate_async(const Glib::RefPtr<TlsConnection>& connection, TlsCertificateRequestFlags flags, const SlotAsyncReady& slot)
{
  ...
  g_tls_interaction_request_certificate_async(gobj(), Glib::unwrap(connection), ((GTlsCertificateRequestFlags)(flags)), nullptr, &SignalProxy_async_callback, slot_copy);
}
...
{
  g_tls_interaction_request_certificate_async(gobj(), Glib::unwrap(connection), ((GTlsCertificateRequestFlags)(flags)), const_cast<GCancellable*>(Glib::unwrap(cancellable)), nullptr, nullptr);
}
...
{
  g_tls_interaction_request_certificate_async(gobj(), Glib::unwrap(connection), ((GTlsCertificateRequestFlags)(flags)), nullptr, nullptr, nullptr);
}
