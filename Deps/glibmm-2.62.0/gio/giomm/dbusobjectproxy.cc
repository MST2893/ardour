...
{
  return Glib::RefPtr<Gio::DBus::ObjectProxy>( dynamic_cast<Gio::DBus::ObjectProxy*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
{
  return Glib::RefPtr<ObjectProxy>( new ObjectProxy(connection, object_path) );
}

Glib::RefPtr<Connection> ObjectProxy::get_connection()
{
  Glib::RefPtr<Connection> retvalue = Glib::wrap(g_dbus_object_proxy_get_connection(gobj()));
  if(retvalue)
