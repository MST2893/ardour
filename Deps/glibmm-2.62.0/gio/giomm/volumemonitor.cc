...
{
  return Glib::ListHandle< Glib::RefPtr<Drive> >(g_volume_monitor_get_connected_drives(gobj()), Glib::OWNERSHIP_DEEP);
}

Glib::ListHandle< Glib::RefPtr<Volume> > VolumeMonitor::get_volumes()
{
  return Glib::ListHandle< Glib::RefPtr<Volume> >(g_volume_monitor_get_volumes(gobj()), Glib::OWNERSHIP_DEEP);
}

Glib::ListHandle< Glib::RefPtr<Mount> > VolumeMonitor::get_mounts()
{
  return Glib::ListHandle< Glib::RefPtr<Mount> >(g_volume_monitor_get_mounts(gobj()), Glib::OWNERSHIP_DEEP);
}
