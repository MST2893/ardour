...
{
  return Glib::RefPtr<Gio::DBus::ObjectSkeleton>( dynamic_cast<Gio::DBus::ObjectSkeleton*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
{
  return Glib::RefPtr<ObjectSkeleton>( new ObjectSkeleton(object_path) );
}
