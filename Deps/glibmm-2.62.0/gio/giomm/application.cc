...
// static
GType Glib::Value<Gio::ApplicationFlags>::value_type()
{
...
{
  GError* gerror = nullptr;
  bool retvalue = g_application_register(gobj(), nullptr, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
Glib::RefPtr<Application> Application::get_default()
{
  ...
  Glib::RefPtr<Application> retvalue = Glib::wrap(g_application_get_default());
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us
  return retvalue;
}
...
Glib::PropertyProxy< bool > Application::property_resource_base_path() 
{
  return Glib::PropertyProxy< bool >(this, "resource-base-path");
}
#endif // GIOMM_DISABLE_DEPRECATED
...
Glib::PropertyProxy_ReadOnly< bool > Application::property_resource_base_path() const
{
  return Glib::PropertyProxy_ReadOnly< bool >(this, "resource-base-path");
}
#endif // GIOMM_DISABLE_DEPRECATED
