...
{
  using namespace Gio;
  using SlotType = sigc::slot< void,const Glib::ustring&,const Glib::StringArrayHandle& >;
  ...
  if(obj)
  {
    try
    {
      if(const auto slot = Glib::SignalProxyNormal::data_to_slot(data))
        (*static_cast<SlotType*>(slot))(Glib::convert_const_gchar_ptr_to_ustring(p0)
, Glib::StringArrayHandle(p1, Glib::OWNERSHIP_NONE)
);
    }
    catch(...)
    {
...
Glib::SignalProxy< void,const Glib::ustring&,const Glib::StringArrayHandle& > MountOperation::signal_ask_question()
{
  return Glib::SignalProxy< void,const Glib::ustring&,const Glib::StringArrayHandle& >(this, &MountOperation_signal_ask_question_info);
}
