...
: // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(nullptr),
  Glib::Object(Glib::ConstructParams(themedicon_class_.init(), "names",Glib::ArrayHandler<Glib::ustring>::vector_to_array(iconnames).data(), nullptr))
{
}
...
{
  return Glib::RefPtr<ThemedIcon>( new ThemedIcon(iconnames) );
}
...
{
  return Glib::StringArrayHandle(g_themed_icon_get_names(const_cast<GThemedIcon*>(gobj())), Glib::OWNERSHIP_NONE);
}
