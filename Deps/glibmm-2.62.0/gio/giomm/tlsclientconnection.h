...
public:
  ...
  /** Since 2.42.1, if @a use_ssl3 is <tt>true</tt>, this forces @a conn to use the
   ...
   * 
   * @param use_ssl3 Whether to use the lowest-supported protocol version.
   */
  ...
  /** Gets whether @a conn will force the lowest-supported TLS protocol
   ...
   * 
   * @return Whether @a conn will use the lowest-supported TLS protocol version.
   */
...
/** If <tt>true</tt>, forces the connection to use a fallback version of TLS
