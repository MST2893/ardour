...
#include <giomm/private/simplepermission_p.h>
...
{
  return Glib::RefPtr<Gio::SimplePermission>( dynamic_cast<Gio::SimplePermission*> (Glib::wrap_auto ((GObject*)(object), take_copy)) );
...
{
  return Glib::RefPtr<SimplePermission>( new SimplePermission(allowed) );
}
